...
import { getFrame, SOLID_FRAME, EMPTY_FRAME, N, NE, E, SE, S, SW, W, NW } from '../../core/autotile';
import type { Grid, LayerData, TerrainCellType } from '@nookstead/shared';
import type { LayerPass } from '../generation-types';

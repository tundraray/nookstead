...
import { ZONE_OVERLAP_ALLOWED } from '../types/map-types';
import type { TileCoord } from './zone-geometry';

/**
 * Result of an overlap check between two zones.
 */
...
/**
 * A validation error describing a disallowed zone overlap.
 */
 ...
 * For rectangle zones: returns all tiles within the bounds.
 * For polygon zones: rasterizes the polygon.
 */
 ...
 * Returns all tile coordinates whose center falls inside the polygon.
 */
 ...
 * Compares against the ZONE_OVERLAP_ALLOWED pairs in both directions.
 */
 ...
 * Returns whether they overlap, whether the overlap is allowed, and the overlapping tiles.
 */
 ...
 * Zones with the same type pair in ZONE_OVERLAP_ALLOWED are skipped.
 */

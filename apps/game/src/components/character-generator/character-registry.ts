...
function makeHairstyle(style: string, color: string): LayerOption {
  return {
    ...
    category: 'hairstyle',
    path: `${BASE_PATH}/hairstyles/${style}_${color}.png`,
...
function makeOutfit(style: string, variant: string): LayerOption {
  return {
    ...
    category: 'outfit',
    path: `${BASE_PATH}/outfits/${style}_${variant}.png`,
...
function makeAccessory(
  ...
  return {
    ...
    category: 'accessory',
    path: `${BASE_PATH}/accessories/${num}_${name}_${variant}.png`,
